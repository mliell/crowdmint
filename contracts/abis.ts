...
//  Generated from compiled Solidity contracts (Hardhat artifacts)
...
export const campaignFactoryAbi = [
  ...
  },
  {
    ...
    "name": "PlatformFeeCollectorUpdated",
    "type": "event"
  },
  {
    "anonymous": false,
  ...
  },
  {
    "inputs": [
      {
        "internalType": "address[]",
        "name": "_campaignAddresses",
        "type": "address[]"
      }
    ],
    "name": "registerExistingCampaigns",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  ...
  },
  {
    "inputs": [
      ...
      {
        "internalType": "enum CrowdMintVault.DepositType",
        "name": "_depositType",
        "type": "uint8"
      },
      {
        "internalType": "address",
        "name": "_originalClaimer",
        "type": "address"
      }
    ],
...
export const campaignAbi = [
  ...
  },
  {
    ...
    "name": "PlatformWithdrawalFeeCollected",
    "type": "event"
  },
  {
    "anonymous": false,
...
export const crowdMintVaultAbi = [
  ...
  {
    "inputs": [],
    "name": "totalPlatformFeesFromVaultClaims",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  {
    "inputs": [],
    "name": "totalPrincipalAvailableForClaim",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  {
    "inputs": [],
    "name": "totalPrincipalIncorporated",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
